---
title: "AI-Curated Democratic Discourse (Stacky)"
collection: projects
# category: manuscripts
permalink: /projects/2_stacky
excerpt: 'I was responsible for designing and implementing an end-to-end data pipeline. This pipeline periodically scraped news articles and comments from the NYT, Fox News, and Reddit, and injected them into our custom Mastodon server to simulate simultaneous, cross-platform discussion.'
start_date: 2024-06-01
end_date: 2025-08-15
ongoing: false
location: CLSP @ Johns Hopkins University
collaborators:
    - Jason Eisner
    - Andrew Perrin
    - Daniel Khashabi
...
See full project proposal [here](https://www.clsp.jhu.edu/ai-curated-democratic-discourse/).